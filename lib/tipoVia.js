...
export const MODIFICACIONES = {
  ...
  'infraestructura-verde': {
    'via-primaria': {
      nota: 'En vía primaria la alta contaminación vehicular exige trampa de aceites previa y mayor separación a cimentaciones.',
      modificados: {
        obligatorias: [
          {
    ...
    'corredor-transporte': {
      nota: 'En corredor BRT la alta carga de hidrocarburos exige trampa certificada y mayor separación a cimentaciones.',
      modificados: {
        obligatorias: [
          {
            parametro: 'Distancia mínima a cimentaciones',
    ...
    'zona-patrimonial': {
      ...
      modificados: {
        manualesNacionales: [
          {
            parametro: 'Profundidad de sustrato en jardín de infiltración',
            valor: '0.20 – 0.40',
            unidad: 'm',
            fuente: 'Criterios INAH / SEDATU',
            detalle: 'En zona patrimonial la profundidad del sustrato se limita a 0.20–0.40 m para evitar afectaciones a estratos arqueológicos o históricos.',
          },
        ],
      },
      adicionales: {
